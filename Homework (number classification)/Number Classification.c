/*Write a C code that takes a number as input from user and determines whether
it's a Positive Real/Negative Real/Natural/Rational/Irrational Number
and gives The feedback to user.*/
